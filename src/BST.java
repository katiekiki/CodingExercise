...
public class BST {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Is head1 a BST? " + isBST(head1));
        System.out.println("Is head2 a BST? " + isBST(head2));
        System.out.println("Is head3 a BST? " + isBST(head3));
        System.out.println("Is head4 a BST? " + isBST(head4));
    ...
    public static boolean isBST(TreeNode node) {
        ...
        return isBSTHelper(node, Integer.MAX_VALUE, Integer.MIN_VALUE);
    }

    public static boolean isBSTHelper(TreeNode node, int upperbound, int lowerbound) {
        ...
        if (node == null) {
            ...
            if (node.val > lowerbound &&
                node.val < upperbound &&
                isBSTHelper(node.left, node.val, lowerbound) &&
                isBSTHelper(node.right, upperbound, node.val)) {
                return true;
            } else {
                return false;
            }
